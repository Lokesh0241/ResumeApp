...
public class CuntryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cuntry);
    ...
    private void displayLoader() {
        pDialog = new ProgressDialog(CuntryActivity.this);
                ...
                (Request.Method.GET, cities_url, null, new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray responseArray) {
                        ...
                        try {
                            ...
                            final StateAdapter stateAdapter = new StateAdapter(CuntryActivity.this,
                            ...
                            stateSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                                ...
                                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                                    ...
                                    ArrayAdapter citiesAdapter = new ArrayAdapter<>(CuntryActivity.this,
