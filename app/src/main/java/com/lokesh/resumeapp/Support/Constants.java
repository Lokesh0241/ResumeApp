...
/**
 * Created by Yatendra sen on 9/12/2016.
 */
public class Constants {

    public static final String APP_NAME = "Doomes";


    public static final String EMAIL_REGEX = "[A-Z0-9a-z._%+-]+@[A-Za-z0-9.-]+\\.[A-Za-z]{2,4}";

    public static final String BASE_URL = "http://35.168.99.29/calendar/webservice/";
